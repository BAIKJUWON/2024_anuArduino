...
// DHT11 센서 설정
#define DHTPIN D2     // DHT 핀이 ESP8266의 D2에 연결됨
...
// WiFi 설정
const char* ssid = "604_2.4G";       // 자신의 SSID로 변경
const char* password = "educom604"; // 자신의 비밀번호로 변경
      ...
      if (client.available()) {
        ...
        if (c == '\n') {
          if (currentLine.length() == 0) {
            ...
            client.print("<body><h1>ESP8266 DHT11 Sensor</h1>");
            ...
            if (isnan(h) || isnan(t)) {
              client.print("<p>Failed to read from DHT sensor!</p>");
            } else {
